...
export const metadata: Metadata = {
  ...
  description: "The terms governing the USA Errands platform — vendor  services, the Personal Shopper service, and use of the website.",
};
      ...
      <div className="mx-auto flex max-w-[60rem] flex-col gap-8 px-6 py-16 sm:px-8">
        <header>
          ...
          <p className="mt-3 max-w-prose text-body text-text-muted">
            These terms govern your use of the USA Errands website, the vendor  platform, and
        ...
        <article className="prose-legal">
          ...
          <p>
            ...
            sellers (&quot;&quot;) and (b) a Personal Shopper service that procures U.S. retail
